...
public class ModuleManager {
    ...
    /**
     * Category-scoped view used by the Selene-style GUI navigation.
     * The returned list is a snapshot so rendering cannot mutate the registry.
     */
    public List<Module> getModulesInCategory(com.slither.cyemer.module.Category category) {
